...
public class PrescriptionAdapter extends FirebaseRecyclerAdapter<
    ...
    public static class DoctorsViewHolder extends RecyclerView.ViewHolder{
        ...
        public void sets(String medicine_A) {
            TextView doctorsNameView = mView.findViewById(R.id.medA);
        ...
        public void setB(String medicine_B) {
            TextView doctorsNameView = mView.findViewById(R.id.medB);
            doctorsNameView.setText(medicine_B);
        }

        public void setC(String medicine_C) {
            TextView doctorsNameView = mView.findViewById(R.id.medC);
            doctorsNameView.setText(medicine_C);
        }

        public void setSos(String sos) {
            TextView doctorsNameView = mView.findViewById(R.id.medE);
            if(sos.isEmpty())
        ...
        public void setTime(String time) {
            TextView doctorsNameView = mView.findViewById(R.id.medD);
